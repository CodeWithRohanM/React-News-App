        ...
        return <>
            ...
            <div className="flex justify-center">
                <div className="rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div className="h-1/2">
                        <a href={this.props.url} target = "_blank"><h5 className="text-gray-900 text-xl font-medium font-bold">{this.props.title}..</h5></a>
